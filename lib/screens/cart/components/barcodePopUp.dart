...
class _BarcodePopupFormState extends State<BarcodePopupForm> {
  String name = '';
  String mrp = '';
  String? selectedCategory; // Change the initial value to null
  File? selectedImage;
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text("This Product Doesn't Exist in the Database",
              ...
              IntrinsicWidth(
                child: DropdownButtonFormField<String>(
                  ...
                  validator: (value) {
                    ...
                    return null;
                  }, // if you want to change categoryName change here as well as in Category Db
                  items: <String>[
                    'Food and Snacks',
  ...
  Future<void> _pickImage() async {
    ...
    if (pickedFile != null) {
      setState(() {
        ...
        print('selectedImage Extension: $selectedImage');
